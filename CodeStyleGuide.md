...
ProjectDD.[Feature].[Subnamespace]

Feature List(temp):

Player, Object, Camera, System, ProcGen, Networking, UI,

```csharp
ProjectDD.UI.CameraMode
ProjectDD.UI.ExpolorMode
namespace ProjectDD.UI.CameraMode{
...
This style guide is a modified version from and credit belongs to
